...
export default function DayPlan() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pb-24">
      ...
      {/* Planned Exercises List omitted for brevity, same as previous version */}
      ...
      {viewingDetails && (
        <div className="fixed inset-0 bg-black/98 z-[100] p-8 flex flex-col items-center justify-center">
          ...
          <p className="text-zinc-400 text-center text-sm italic mb-12 max-w-sm leading-relaxed">{viewingDetails.description || "Premium movement data."}</p>
